...
function Show-Header {
    ...
    Write-Host "                   SWAIF PLATFORM - REAL-TIME SERVICE MONITOR                  " -ForegroundColor White
    Write-Host "===============================================================================" -ForegroundColor Cyan
    Write-Host ""
}
...
function Get-ServiceStatus {
    ...
    try {
        $result = docker ps --filter "name=$ContainerName" --format "table {{.Names}}\t{{.Status}}" | Select-Object -Skip 10
        if ($result) {
            return "Running"
        } else {
            return "Stopped"
...
function Show-ServiceDetails {
    ...
    Write-Host ""
    Write-Host "===============================================================================" -ForegroundColor Cyan
    Write-Host "                               SERVICE DETAILS                                " -ForegroundColor White -BackgroundColor DarkBlue
    Write-Host "===============================================================================" -ForegroundColor Cyan
    Write-Host ""
